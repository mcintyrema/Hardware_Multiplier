...
proc create_root_design { parentCell } {
  ...
  set TopLevel_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:TopLevel:1.0 TopLevel_0 ]
  ...
  connect_bd_net -net TopLevel_0_Done [get_bd_pins TopLevel_0/Done] [get_bd_pins axi_regmap_0/REG1_IN]
  connect_bd_net -net TopLevel_0_R [get_bd_pins TopLevel_0/R] [get_bd_pins splitter_0/R]
  connect_bd_net -net axi_regmap_0_REG0_OUT [get_bd_pins TopLevel_0/A] [get_bd_pins axi_regmap_0/REG0_OUT]
  connect_bd_net -net axi_regmap_0_REG1_OUT [get_bd_pins TopLevel_0/Rst] [get_bd_pins axi_regmap_0/REG1_OUT]
  connect_bd_net -net axi_regmap_0_REG2_OUT [get_bd_pins TopLevel_0/B] [get_bd_pins axi_regmap_0/REG2_OUT]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins TopLevel_0/Clk] [get_bd_pins processing_system7_0/FCLK_CLK1]
  ...
  connect_bd_net -net splitter_0_R_lsb [get_bd_pins axi_regmap_0/REG2_IN] [get_bd_pins splitter_0/R_lsb]
  connect_bd_net -net splitter_0_R_msb [get_bd_pins axi_regmap_0/REG0_IN] [get_bd_pins splitter_0/R_msb]
